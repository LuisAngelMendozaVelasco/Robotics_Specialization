...
unzip('./data/apriltagims.zip', "./data/");
...
% test_images = [1,4,10];
initial_points = 1.0e+02 * [1.981631469726562   3.165294189453125
...
% end
%
K = 1.0e+02 * [7.661088867187500                   0   3.139585628047498
...
play_video(generated_imgs, 25);
rmdir ./data/apriltagims s;